        ...
        <ModalContent>
          ...
          >
            <header className=" capitalize">
              <h1 className="text-2xl font-bold">add physicians</h1>
              <p>select a specialty,title or physician details</p>
            </header>
            ...
            <div className="flex justify-end space-x-3">
              <button type="submit" className="border p-1 px-3 capitalize">
                save
              </button>
              <button className="border p-1 px-3 capitalize" onClick={onClose}>
                cancel
              </button>
            </div>
          </form>
