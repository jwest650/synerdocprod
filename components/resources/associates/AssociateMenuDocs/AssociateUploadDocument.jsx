                    ...
                    <div className="flex w-full flex-col items-center gap-3.5">
                      <div className="flex w-full items-center justify-center gap-3 ">
                        <p className="flex w-[35%]  justify-end">
                          <span className="text-primary-orange">*</span>Select
                          file:
                        </p>
                      ...
                      <div className="flex w-full items-center justify-center gap-3 ">
                        ...
                        <div className=" flex w-[65%] items-center gap-2">
                          <TableSelect
                            ...
                            options={['Select', 'Associate', 'Option2']}
                          />
                        </div>
                      </div>
                      {resourceName !== '' && (
                        <div className="flex w-full items-center justify-center gap-3 ">
                          <p className="flex w-[35%] justify-end">Name:</p>
                          <div className=" flex w-[65%] items-center gap-2">
                            <p className="input-primary">{resourceName}</p>
                          </div>
                        </div>
                      )}
                      <div className="flex w-full items-center justify-center gap-3 ">
