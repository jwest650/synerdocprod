          ...
          <div className="w-full rounded border-[2px] border-t-[20px] border-[#c6d8ffe1] p-4 pb-10 ">
            ...
            <form action="" onSubmit={handleForm}>
              ...
              <div className="mt-16 flex flex-col items-center lg:flex-row lg:items-start">
                ...
                <div className="mt-12 flex gap-5 lg:flex-none">
                  <span className="flex h-5 w-5 items-center justify-center rounded-full bg-primary-blue text-sm font-semibold text-white lg:mt-0">
                    3
                  </span>
                  <table className=" mx-auto mt-5 w-fit overflow-auto px-3 shadow-md">
                    <thead className="border-b bg-primary-blue text-[18px] tracking-wider text-white">
                      <tr>
                        ...
                        <th className=" border-primary-gray border-t-primary-blue border-r-primary-blue pl-2 text-left"></th>
                      </tr>
                    </thead>
                    <tbody>
