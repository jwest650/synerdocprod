  ...
  return (
    <>
      ...
      >
        ...
        <span className="verdana11">Create License</span>
      </span>
        ...
        <ModalContent>
          <div className="w-full rounded border-[2px] border-t-[20px] border-[#c6d8ffe1] p-4 pb-10 ">
            <form action="" onSubmit={handleForm}>
              <h1 className="verdana18 font-semibold">Create License</h1>
              <p className="verdana12">Create a new license</p>
...
export default PhysicianCreateLicense;
