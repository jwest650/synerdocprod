...
import ReferralEditAddressInfo from './ReferralEditAddressInfo';

const ReferralContactInfoTable = () => {
  return (
...
export default ReferralContactInfoTable;
