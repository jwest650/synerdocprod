          ...
          <div className="w-full rounded border-[2px] border-t-[20px] border-[#6b3e9280] p-4 pb-10 ">
            ...
            >
              <header className=" capitalize">
                <h1 className="text-2xl font-bold">add Referral source</h1>
                <p>add referral source details</p>
              </header>
              <section className="ml-12 space-y-3">
                <div className="flex space-x-2">
                  <label htmlFor="">
                    <span className="text-orange-500">*</span> referral type:
                  </label>{' '}
                ...
                <div className="flex items-center space-x-2">
                  <label htmlFor="">
                    <span className="text-orange-500">*</span> facilite name:
                  </label>
                ...
                <div className="flex space-x-2">
                  <label htmlFor="">
                    <span className="text-orange-500">*</span> facilite type:
                  </label>
                  <Select placeholder="Select option" size="xs" w={120}>
                    <option value="option1">Option 1</option>
                    <option value="option2">Option 2</option>
                ...
                <div className="flex space-x-2">
                  <label htmlFor="">
                    <span className="text-orange-500">*</span> sales rep:
                  </label>
                  <Select placeholder="Select option" size="xs" w={120}>
                    <option value="option1">Option 1</option>
                    <option value="option2">Option 2</option>
                ...
                <div className="space-x-2">
                  <label htmlFor="">
                    <span className="text-orange-500">*</span> start date:
                  </label>
                  <Input w={150} type="date" size="sm" placeholder="" />
                </div>
                <div className="space-x-2">
