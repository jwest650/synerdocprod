  ...
  return (
    <>
      ...
      >
        ...
        <span className="verdana11">Create Licence</span>
      </span>
        ...
        <ModalContent>
          <div className="w-full rounded border-[2px] border-t-[20px] border-[#c6d8ffe1] p-4 pb-10 ">
            <form action="" onSubmit={handleForm}>
              <h1 className="verdana16 font-semibold">Create License</h1>
...
export default ReferralCreateLicense;
