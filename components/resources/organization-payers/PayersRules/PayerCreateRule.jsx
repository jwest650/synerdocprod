        ...
        <ModalContent>
          <div className="w-full rounded border-[2px] border-t-[20px] border-[#c6d8ffe1] p-4 pb-10 ">
            <form action="" onSubmit={handleForm}>
              <h1 className="verdana16 font-semibold">Create Payer Rule</h1>
              <p className="verdana11">Create Payer Rule Details</p>
...
export default PayerCreateRule;
