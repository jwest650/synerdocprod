  ...
  return (
    <>
      ...
      >
        ...
        <span className="verdana11">Create Payer Carrier Code</span>
      </span>
          ...
          <div className="w-full rounded border-[2px] border-t-[20px] border-[#c6d8ffe1] p-4 pb-10 ">
            <form action="" onSubmit={handleForm}>
              <h1 className="verdana16 font-semibold">
                Create Payer Carrier Code
              </h1>
              <div className="verdana12 mt-8">
                <div className="flex w-full flex-col items-center gap-3.5">
                  <div className="flex w-full items-center justify-center gap-3 ">
                    <p className="flex w-[35%]  justify-end">
                      <span className="text-primary-orange">*</span>Relational
                      Payer:
                    </p>
                    <div className=" flex w-[65%] gap-2">
                      <TableSelect options={['Aetna', 'Option2']} />
                    </div>
                  </div>
                  <div className="flex w-full items-center justify-center gap-3 ">
                    <p className="flex w-[35%] justify-end">
                      <span className="text-primary-orange">*</span>Carrier
                      Code:
                    </p>
...
export default PayerCreateCarrierCode;
