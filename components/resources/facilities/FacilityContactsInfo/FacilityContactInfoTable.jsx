...
import FacilityEditAddressInfo from './FacilityEditAddressInfo';

const FacilityContactInfoTable = () => {
  return (
...
export default FacilityContactInfoTable;
