...
import CreateFacilites from '../../dashboard/CreateFacilites';
        ...
        <table className="mt-10 min-w-full overflow-auto capitalize">
          <thead className="border-b bg-[#32164A] text-[18px] tracking-wider text-white">
            <tr>
              ...
              <th className=" border-gray-100 pl-2 text-left">Patient Name</th>
          ...
          <tbody>
            ...
            {physiciansData.map((value, i) => (
              ...
              >
                ...
                <td className="border  border-gray-400">{value.email}</td>
                <td className="border  border-gray-400">{value.numbers}</td>
                <td className="border  border-gray-400">{value.title}</td>
                <td className="border  border-gray-400">{value.active}</td>
                <td></td>
              </tr>
            ))}
            <tr>
