...
const MoreAddressInfo = () => {
  return (
    <div className="verdana10 absolute bottom-5 -right-16 z-10 ">
      <div className="moreInfo-anim w-72 rounded border-[4px] border-t-[10px] border-[#c6d8ffe1] bg-white">
      ...
      <span className="-mt-0.5 flex w-full justify-center text-[#c6d8ffe1]">
